...
json_file = '/path/to/your/audio_results.json'  # Update this path for audio results
...
# --- Deepfake Detection Evaluation for Audio ---
# Using 'real_score' as ground truth and 'model_score' as the model's binary prediction.
...
plt.title('ROC Curve for Audio Deepfake Detection')
plt.legend(loc='best')
plt.grid(True)
...
plt.title('Precision-Recall Curve for Audio Deepfake Detection')
plt.legend(loc='best')
plt.grid(True)
...
ax.set_title('Confusion Matrix for Audio Deepfake Detection\n(model_score vs real_score)')
